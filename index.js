...
async function display(){
    ...
    let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=newtonschool%20video&key=AIzaSyBPCwXIL0Eg-X18TfF4Axy7Sbmc68nI8NE&maxResults=20`);
...
//search for videos
let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=${query}&type=video&key=AIzaSyBPCwXIL0Eg-X18TfF4Axy7Sbmc68nI8NE&maxResults=20`);
let data = await res.json();
